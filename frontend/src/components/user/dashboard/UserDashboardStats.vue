<template>
  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    ...
    <div v-if="!isSimple" class="card p-4">
      <div class="flex items-center gap-3">
        <div class="dashboard-icon-tile">
          <svg class="dashboard-accent-text h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <p class="dashboard-accent-text text-xl font-bold">${{ formatBalance(balance) }}</p>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="dashboard-icon-tile">
          <Icon name="key" size="md" class="dashboard-accent-text" :stroke-width="2" />
        </div>
        <div>
          ...
          <p class="dashboard-accent-text text-xs">{{ stats?.active_api_keys || 0 }} {{ t('common.active') }}</p>
        </div>
      </div>
    </div>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="dashboard-icon-tile">
          <Icon name="chart" size="md" class="dashboard-accent-text" :stroke-width="2" />
        </div>
        <div>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="dashboard-icon-tile">
          <Icon name="dollar" size="md" class="dashboard-accent-text" :stroke-width="2" />
        </div>
        <div>
          <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ t('dashboard.todayCost') }}</p>
          <p class="text-xl font-bold text-gray-900 dark:text-white">
            <span class="dashboard-accent-text" :title="t('dashboard.actual')">${{ formatCost(stats?.today_actual_cost || 0) }}</span>
          ...
          <p class="text-xs">
            ...
            <span class="dashboard-accent-text" :title="t('dashboard.actual')">${{ formatCost(stats?.total_actual_cost || 0) }}</span>
  ...
  <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="dashboard-icon-tile">
          <Icon name="cube" size="md" class="dashboard-accent-text" :stroke-width="2" />
        </div>
        <div>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="dashboard-icon-tile">
          <Icon name="database" size="md" class="dashboard-accent-text" :stroke-width="2" />
        </div>
        <div>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="dashboard-icon-tile">
          <Icon name="bolt" size="md" class="dashboard-accent-text" :stroke-width="2" />
        </div>
        <div class="flex-1">
          ...
          <div class="flex items-baseline gap-2">
            <p class="dashboard-accent-text text-sm font-semibold">{{ formatTokens(stats?.tpm || 0) }}</p>
    ...
    <div class="card p-4">
      <div class="flex items-center gap-3">
        <div class="dashboard-icon-tile">
          <Icon name="clock" size="md" class="dashboard-accent-text" :stroke-width="2" />
        </div>
        <div>
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
      ...
      >
        <div class="flex items-center justify-between">
          ...
          <span class="dashboard-accent-text font-mono text-sm" :title="t('dashboard.actual')">
        ...
        <div v-if="hasAnyLimit(item.quota) && !item.isOther" class="mt-3 space-y-1.5 pt-1.5">
...
function quotaBarClass(p: number): string {
  ...
  if (p >= 75) return 'dashboard-quota-warn'
  return 'dashboard-quota-ok'
}
