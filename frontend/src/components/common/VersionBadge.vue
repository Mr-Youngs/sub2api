    ...
    <template v-if="isAdmin">
      ...
      <transition name="dropdown">
        <div
          v-if="dropdownOpen"
          ref="dropdownRef"
          class="absolute left-0 z-50 mt-2 w-64 overflow-hidden rounded-md border border-gray-200 bg-white shadow-sm dark:border-dark-700 dark:bg-[#292C3B]"
        >
            ...
            <template v-else>
              ...
              <div v-else-if="updateSuccess && needRestart" class="space-y-2">
                ...
                >
                  ...
                  <div class="min-w-0 flex-1">
                    <p class="text-sm font-medium text-dark-900 dark:text-primary-100">
