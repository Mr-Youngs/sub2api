<template>
  <header class="glass sticky top-0 z-30 border-b border-gray-200/70 dark:border-dark-700/60">
    <div class="flex h-16 items-center justify-between px-4 md:px-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <div
          v-if="user"
          class="hidden items-center gap-2 rounded-md bg-primary-100 px-3 py-1.5 dark:bg-primary-500/15 sm:flex"
        >
          <svg
          ...
          <span class="text-sm font-semibold text-dark-900 dark:text-primary-200">
        ...
        <div v-if="user" class="relative" ref="dropdownRef">
          ...
          >
            <div class="flex h-8 w-8 items-center justify-center overflow-hidden rounded-md bg-dark-900 text-sm font-medium text-white shadow-sm">
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
                :alt="displayName"
          ...
          <transition name="dropdown">
            <div v-if="dropdownOpen" class="dropdown right-0 mt-2 w-56">
              ...
              <div class="border-b border-gray-100 px-4 py-2 dark:border-dark-700 sm:hidden">
                ...
                <div class="text-sm font-semibold text-dark-900 dark:text-primary-300">
                  ${{ user.balance?.toFixed(2) || '0.00' }}
                </div>
              </div>
